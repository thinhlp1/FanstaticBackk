...
public class VoucherService {
    ...
    public ResponseDTO create(VoucherRequestDTO voucherRequestDTO) {
        // Tạo 1 list để lưu trữ lỗi, khi thông báo lỗi thì truyền nó lên -> mục đích để
        // thông báo lỗi 1 lượt
    ...
    public ResponseDTO delete(int id) {
        ...
        /*
         * XÓA MỀM -> nên sau khi đổi active thành false sẽ save lại đối tượng giống như
         * update
         */
