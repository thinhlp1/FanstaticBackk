...
public interface FlavorRepository extends JpaRepository<Flavor, Integer> {
    public Optional<List<Flavor>> findAllByActiveIsTrueOrderByCreateAtDesc();

    public Optional<List<Flavor>> findAllByActiveIsFalseOrderByCreateAtDesc();
    ...
    public List<Flavor> findAllByOrderByCreateAtDesc();
