...
public class WebSecurityConfig {
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost", "https://7eca-171-247-200-81.ngrok-free.app", "http://vivit.live", "http://localhost:3000", "http://192.168.1.16", "http://103.74.107.114", "http://fanstatic.vivit.live"));
